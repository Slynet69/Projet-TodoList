...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
            // TODO: write test-'should show active entries-DONE
		...
		it('should show completed entries', function () {
            // TODO: write test-should show completed entries-DONE
	...
	it('should highlight "All" filter by default', function () {
        // TODO: write test--should highlight "All" filter by default-DONE
		var todo = {title: 'my todo'};
        setUpModel([todo]);
        subject.setView('#/');
	...
	it('should highlight "Active" filter when switching to active view', function () {
        // TODO: write test-should highlight "Active" filter when switching to active view-DONE
		var todo = {title: 'my todo',completed :true};    
        setUpModel([todo]);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
		  var todo = {id: 48, title: 'my todo', completed : false};
		  setUpModel([todo]);
          subject.setView('#/');  
        ...
        // TODO: write test-should update the view-DONE    
           var todo = {id: 48, title: 'my todo',completed : false};
            setUpModel([todo]);
            subject.setView('#/');  
            subject.toggleAll(true);
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			// TODO write test-should add a new todo to the model-DONE
			setUpModel([]);
            subject.setView('');
            var todo = 'my todo';
            
			subject.addItem(todo);
            expect(model.create).toHaveBeenCalledWith(todo, jasmine.any(Function));
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
              // TODO: write test-should remove an entry from the model-DONE
			var todo = {id: 42, title: 'my todo', completed: true};
			setUpModel([todo]);
